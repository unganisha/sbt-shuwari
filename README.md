...
```scala
addSbtPlugin("africa.shuwari.sbt" % "sbt-shuwari-core" % "0.12.0")
```
...
```scala
addSbtPlugin("africa.shuwari.sbt" %  "sbt-shuwari-header" % "0.12.0")
```
...
```scala
addSbtPlugin("africa.shuwari.sbt" %  "sbt-shuwari-mode" % "0.12.0")
```
