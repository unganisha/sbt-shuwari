...
```scala
addSbtPlugin("africa.shuwari.sbt" % "sbt-shuwari" % "0.9.4")
```
...
```scala
addSbtPlugin("africa.shuwari.sbt" % "sbt-shuwari-core" % "0.9.4")
```
...
```scala
addSbtPlugin("africa.shuwari.sbt" %  "sbt-shuwari-header" % "0.9.4")
```
...
```scala
addSbtPlugin("africa.shuwari.sbt" %  "sbt-shuwari-mode" % "0.9.4")
```
